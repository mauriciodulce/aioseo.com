...
class Admin {
	...
	public function addPublishScore( $postObj ) {
		...
		$currentPostType = $postObj->post_type;
		$showMetabox     = aioseo()->options->searchAppearance->dynamic->postTypes->$currentPostType->advanced->showMetaBox;
		...
		if ( in_array( $postObj->post_type, $postTypesMB, true ) && $showTruSeo && ! $isSpecialPage && $showMetabox ) {
